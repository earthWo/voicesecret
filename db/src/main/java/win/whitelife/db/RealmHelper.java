...
public class RealmHelper {
    ...
    private static Object parseMethod(Method method, Object[] args){
    ...
    private static Object parseModifyMethod(Object[]args){
    ...
    private static Object parseUpdateMethod(Object[]args){
    ...
    private static Object parseSearchMethod(Object[]args){
        Object returnObject = null;
        if(args!=null&&args.length>0){
            Object o=args[0];
    ...
    private static Object parseAddMethod(Object[] args){
        Object returnObject = null;
        if(args!=null&&args.length>0){
           Object o=args[0];
            if(o instanceof List){
    ...
    private static Object parseDeleteMethod(Object[]args){
        Object returnObject = null;
        if(args!=null&&args.length>0){
            Object o=args[0];
            //删除整个数组
